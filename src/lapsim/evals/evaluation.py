...
#     percentage_ci25: float
#     percentage_ci50: float
#     percentage_ci75: float
...
#     apex_max: float
#
#     # todo add 75ci, 50ci and 25ci for all position velocity and laptime
#
#     @staticmethod
...
#             ci25=get_percentile(np.abs(deltas), 0.25),
#             ci50=get_percentile(np.abs(deltas), 0.50),
#             ci75=get_percentile(np.abs(deltas), 0.75),
#             ci95=get_percentile(np.abs(deltas), 0.95),
#
#             percentage_mean=float(np.mean(percentage_errors)),
#             percentage_max=np.max(percentage_errors),
#             percentage_ci25=get_percentile(percentage_errors, 0.25),
#             percentage_ci50=get_percentile(percentage_errors, 0.50),
#             percentage_ci75=get_percentile(percentage_errors, 0.75),
#             percentage_ci95=get_percentile(percentage_errors, 0.95),
#
...
#             ci25=_mean([item.ci25 for item in comparisons]),
#             ci50=_mean([item.ci50 for item in comparisons]),
#             ci75=_mean([item.ci75 for item in comparisons]),
...
#             percentage_ci25=_mean([item.percentage_ci25 for item in comparisons]),
#             percentage_ci50=_mean([item.percentage_ci50 for item in comparisons]),
#             percentage_ci75=_mean([item.percentage_ci75 for item in comparisons]),
...
#
# @dataclasses.dataclass
# class EvaluationLapTimeCombination:
#     truth: float
#     predicted: float
#     error: float
#     abs_error: float
...
#         return Evaluation(
#             laptime=EvaluationLapTimeCombination.combine([x.laptime for x in comparisons]),
